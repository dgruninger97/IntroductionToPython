...
#   As always, test by running the module.
#
david_gruninger = rg.SimpleTurtle('turtle')
david_gruninger.pen = rg.Pen('blue', 20)
david_gruninger.speed = 15
david_gruninger.left(20)
david_gruninger.backward(50)
david_gruninger.forward(60)
